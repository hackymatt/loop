...
import AccountEarningsCompanyTableRow from "src/sections/account/admin/account-earnings-table-company-row";
...
const TABLE_HEAD = [
  ...
  { id: "cost", label: "Koszt" },
  { id: "profit", label: "Przychód" },
  { id: "balance", label: "Dochód" },
];
