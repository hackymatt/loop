...
import { useDeleteCandidate } from "src/api/candidates/candidate";
...
export default function CandidateDeleteForm({ candidate, onClose, ...other }: Props) {
  ...
  return (
    ...
    >
      <FormProvider methods={methods} onSubmit={onSubmit}>
        <DialogTitle sx={{ typography: "h3", pb: 3 }}>Usuń kandydata</DialogTitle>

        <DialogContent sx={{ py: 0 }}>
          <Typography>{`Czy na pewno chcesz usunąć temat ${candidate.name}?`}</Typography>
        </DialogContent>
