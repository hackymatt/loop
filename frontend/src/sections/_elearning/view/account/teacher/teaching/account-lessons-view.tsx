...
import FilterPrice from "src/sections/_elearning/filters/filter-price";
import FilterSearch from "src/sections/_elearning/filters/filter-search";
import FilterDuration from "src/sections/_elearning/filters/filter-duration";
import AccountTableHead from "src/sections/_elearning/account/account-table-head";
import AccountTeachingsTableRow from "src/sections/_elearning/account/teacher/account-teachings-table-row";
