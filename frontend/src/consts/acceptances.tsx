...
export const newsletterAcceptance = (
  <Typography variant="caption" align="left" sx={{ color: "text.secondary", textAlign: "justify" }}>
    ...
    dotyczących usług oraz w celu otrzymywania newslettera (informacji o promocjach, nowościach i
    innych oferowanych atrakcjach) – więcej informacji uzyskają Państwo{" "}
    <Link
      target="_blank"
      rel="noopener"
      href={paths.privacyPolicy}
