...
<p><img alt="Marketing image 1" src='/assets/images/${name}/${name}-large-2.webp' /></p>
...
<p><img alt="Marketing image 2" src='/assets/images/${name}/${name}-large-3.webp' /></p>
...
export const _marketingPosts = [...Array(12)].map((_, index) => ({
  ...
  heroUrl: `/assets/images/marketing/marketing-large-1.webp`,
}));
...
export const _travelPosts = [...Array(12)].map((_, index) => ({
  ...
  heroUrl: `/assets/images/travel/travel-large-1.webp`,
}));
...
export const _careerPosts = [...Array(12)].map((_, index) => ({
  ...
  heroUrl: `/assets/images/career/career-large-1.webp`,
}));
...
export const _coursePosts = [...Array(12)].map((_, index) => ({
  ...
  heroUrl: `/assets/images/course/course-large-1.webp`,
}));
